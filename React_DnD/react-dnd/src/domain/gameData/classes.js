export const CLASSES = {
  Barbarian: {
    base: {
      ...
      startingEquipment: {
        A: ["greataxe", "handaxe"],
        B: ["handaxe", "handaxe", "club"],
        C: ["explorers_pack", "javelin"],
      },
    },
  ...
  Bard: {
    base: {
      ...
      startingEquipment: {
        A: ["rapier", "shortsword", "dagger"],
        B: ["dungeoneers_pack", "musicians_instrument"],
        C: ["lute", "musicians_instrument"],
      },
    },
  ...
  Cleric: {
    base: {
      ...
      startingEquipment: {
        A: ["mace", "warhammer"],
        B: ["scale_mail", "leather", "chain_mail"],
        C: ["light_crossbow", "sling"],
        D: ["priest_pack", "explorers_pack"],
        E: ["shield"],
      },
    },
  ...
  Druid: {
    base: {
      ...
      startingEquipment: {
        A: ["shield", "club"],
        B: ["scimitar", "quarterstaff"],
        C: ["leather", "explorers_pack", "druidic_focus"],
      },
    },
